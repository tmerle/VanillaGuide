...
Table_003_Horde_40to50 = {
	[4041] = {
		...
		--L- Needs to be split
			...
			[22] = { str = "Turn in #INNothing But the Truth# at the guy next to the questiver" },
			[23] = { str = "Get #GETNothing But the Truth# again" },
			[24] = { str = "Then run into Swamp of Sorrows." },
		}
	},
	[4142] = {
	...
	[4343] = {
		...
		items = {
			...
			[5] = { str = "Do #DOMarg Speaks#, kill the mobs at around #COORD[58,63]#", x = 58, y = 63, zone = "Dustwallow Marsh" },
	...
	[4647] = {
		...
		items = {
			...
			[5] = { str = "The go do #DOWhiskey Slim's Lost Grog#, #DOVilebranch Hooligans#, #DOCannibalistic Cousins# " },
			[6] = { str = "#DOA Sticky Situation# turn in later, accept #GETRipple Delivery# " },
		--L- hm?
			[7] = { str = "Do #DOStalking the Stalkers#, #DOHunt the Savages#, #DOTesting the Vessel#, #DOAvenging the Fallen#, #DOLines of Communication#, #DOMessage to the Wildhammer#." },
			[8] = { str = "Do #DORin'ji is Trapped!#, escort quest that starts at #COORD[31,48]#", x = 31, y = 48, zone = "Hinterlands" },
			[9] = { str = "Do #DOGrim Message#, be sure to accept #GETVenom Bottles# from one of those little bottles on the table." },
			[10] = { str = "If #ITEMOOX-09/HL Distress Beacon# drops, accept the quest #GETFind OOX-09/HL!#. Turn it in at #COORD[49,38]#", x = 49, y = 38, zone = "Hinterlands" },
			[11] = { str = "Turn in #INRin'ji is Trapped!# at #COORD[86,59]#, accept #GETRin'ji's Secret# ", x = 86, y = 59, zone = "Hinterlands" },
			[12] = { str = "Go to Revantusk Village, and turn in ALL the quests." },
			[13] = { str = "Then get flightpath, and fly to Tarren Mill." },
			[14] = { str = "Turn in #INVenom Bottles#, accept #GETUndamaged Venom Sac# " },
			[15] = { str = "Then ride back into Hinterlands, don’t fly!" },
			[16] = { str = "Go do #DOUndamaged Venom Sac# and #DOThe Atal'ai Exile#, accept #GETReturn to Fel'Zerul# " },
			[17] = { str = "When done, hearth to Tarren Mill." },
			[18] = { str = "Turn in #INUndamaged Venom Sac#, SKIP #SKIPConsult Master Gadrin# Only accept this quest if you still need to get a mount as orc/troll, as you turn it in in the same spot." },
			[19] = { str = "Fly to Undercity." },
			[20] = { str = "Turn in #INLines of Communication# and #INRin'ji's Secret#, then complete #INOran's Gratitude# " },
			[21] = { str = "Get on the zeppelin to Grom'gol." },
		}
	},
	[4747] = {
		...
		items = {
			...
			[2] = { str = "Go do #DORaptor Mastery#, kill #NPCTethis# at#COORD[28,44]# and go turn it in", x = 28, y = 44, zone = "Stranglethorn Vale" },
			[3] = { str = "Accept #GETBig Game Hunter# (Elite), go do it, then turn it in." },
			[4] = { str = "Go to Grom'gol and turn in #INGrim Message#." },
			[5] = { str = "Fly to Booty Bay." },
			[6] = { str = "Accept #GETThe Bloodsail Buccaneers pt.5# and #GETWhiskey Slim's Lost Grog# " },
			[7] = { str = "Make Booty Bay your home." },
			[8] = { str = "Accept #GETThe Captain's Chest# (Elite) then go do it at #COORD[36,65]# NOTE: This quest is tough to solo, it can be soloed, but you should find a group to help you kill Gorlash.", x = 36, y = 65, zone = "Stranglethorn Vale" },
			[9] = { str = "Turn in #INBack to Booty Bay# and #INDeliver to MacKinley# " },
			[10] = { str = "Find #ITEM[Half-Buried Bottle]# laying around the shore east of Booty Bay #COORD[33,76]#, until #ITEMCarefully Folded Note# drop, which starts #GETMessage in a Bottle# ", x = 33, y = 76, zone = "Stranglethorn Vale" },
			[11] = { str = "Go turn #INMessage in a Bottle# in at #COORD[38,80]#", x = 38, y = 80, zone = "Stranglethorn Vale" },
			[12] = { str = "Then go do #DOThe Bloodsail Buccaneers pt.5#, kill the three pirates in the three ships, while doing it, find #GETCortello's Riddle#, it's usually a little scroll downstairs in the middle ship." },
			[13] = { str = "Then hearth back to Booty Bay, if hearth stone still is on a cooldown, die on purpose." },
			[14] = { str = "Turn in #INThe Captain's Chest# and #INThe Bloodsail Buccaneers pt.5#" },
			[15] = { str = "Get 15x #ITEM[Silk Cloth]# from the bank/AH for a later quest." },
			[16] = { str = "Fly to Kargath (Badlands)." },
			[17] = { str = "Go into Searing Gorge." },
		}
	},
	[4748] = {
		...
		items = {
			...
			[2] = { str = "Go south-east and do #DOCaught!#, guy in the outhouse #COORD[65,62]#, then turn it in. Accept #GETLedger from Tanaris#, click on outhouse to get the #ITEM[Goodsteel Ledger]#", x = 65, y = 62, zone = "Searing Gorge" },
			...
			[5] = { str = "Do the following #DOFiery Menace!#, #DOCurse These Fat Fingers#, #DOSTOLEN: Smithing Tuyere and Lookout's Spyglass#, #DOThe Flawless Flame# - Turn in, then get and do #DOForging the Shaft#, #DOJOB OPPORTUNITY: Culling the Competition# " },
			[6] = { str = "#DOWANTED: Overseer Maltorius# (Elite) (only do this quest with a group, even a level 60 has a hard time soloing this quest)." },
			[7] = { str = "#DOWhat the Flux?# - the plans are right behind #NPCOverseer Maltorius#, #DOIncendosaurs? Whateverosaur is More Like It# " },
			[8] = { str = "#DOThe Key to Freedom# starts from an item drop #ITEM[Grimsite Outhouse Key]#, turn in at the outhouse, south-east at #COORD[65,62]#", x = 65, y = 62, zone = "Searing Gorge" },
			[9] = { str = "Turn in #INForging the Shaft#, accept #GETThe Flame's Casing# " },
			[10] = { str = "Do #DOThe Flame's Casing# around #COORD[24,36]#. Just keep killing the mobs there until the item drops.", x = 24, y = 36, zone = "Searing Gorge" },
			[11] = { str = "Turn in #INThe Flame's Casing#, accept and do #DOThe Torch of Retribution#, turn it in, accept and do #DOThe Torch of Retribution pt.2#, just pick up the torch on the ground." },
			[12] = { str = "Accept #GETSquire Maltrake#, turn it in, accept #GETSet Them Ablaze!# " },
			[13] = { str = "Do #DOSet Them Ablaze!# North=#COORD[33,54]#, South=#COORD[44,61]#, East=#COORD[50,54]#, West=#COORD[35,60]#. Once that is done, go back and turn it in.", x = 33, y = 54, zone = "Searing Gorge" },
			[14] = { str = "Click on the little chest on the ground at #COORD[38,38]# and accept #GETTrinkets...# , then click on the chest again to turn it in.", x = 38, y = 38, zone = "Searing Gorge" },
			[15] = { str = "Make sure you keep the #ITEM[Black Dragonflight Molt]# in your inventory, as you will need it for a later quest." },
			[16] = { str = "Once all that's done, turn all Searing Gorge quests in. Make sure you have all 20 #ITEM[Solid Crystal Leg Shaft]#." },
			[17] = { str = "Head south into Burning Steppes, via Black Rock Mountains." },
			[18] = { str = "Get flightpath there at #COORD[65,25]#, and fly directly to Stonard (Swamp of Sorrows).", x = 65, y = 25, zone = "Burning Steppes" },
		}
	},
	[4848] = {
		...
		items = {
			...
			[4] = { str = "Then go do #DOCortello's Riddle# at #COORD[22,48]#, under the bridge. Accept #GETCortello's Riddle pt.2#", x = 22, y = 48, zone = "Swamp of Sorrows" },
			...
			[9] = { str = "Go to the #NPCFallen Hero of the Horde# #COORD[34,66]# and turn in #INThe Swamp Talker# ", x = 34, y = 66, zone = "Swamp of Sorrows" },
			[10] = { str = "Accept and do #DOA Tale of Sorrow#, just talk to the guy." },
			[11] = { str = "Hearth to Booty Bay, and get on the boat to Ratchet." },
			[12] = { str = "Fly to Brackenwall Village (Dustwallow Marsh). Once there accept #GETThe Brood of Onyxia pt.3# " },
			[13] = { str = "Then head south and get the #ITEMOverdue Package# for the quest #DOLedger from Tanaris# at #COORD[54,55]#", x = 54, y = 55, zone = "Dustwallow Marsh" },
			[14] = { str = "Go down a bit and do #DOThe Brood of Onyxia#, the #ITEM[Eggs of Onyxia]# can be found at #COORD[53,72]# and #COORD[48,75]#", x = 53, y = 72, zone = "Dustwallow Marsh" },
			[15] = { str = "Then head west to Bloodfen Burrow cave #COORD[32,67]#, and do #DOCortello's Riddle#, accept the next part to it.", x = 32, y = 67, zone = "Dustwallow Marsh" },
			[16] = { str = "Turn in #INThe Brood of Onyxia#, accept #GETChallenge Overlord Mok'Morokk#. Do #DOChallenge Overlord Mok'Morokk# Then turn it in." },
			[17] = { str = "Fly to Tanaris." },
			[18] = { str = "Turn in #INLedger from Tanaris# and #INInto the Field#, accept and complete #DOSlake that Thirst# using #ITEM[Wastewander Water Pouch]# from your bank." },
			[19] = { str = "Fly to Feralas." },
		}
	},
	[4849] = {
		title = "48-49 Feralas",
		...
		items = {
			[1] = { str = "48-49 Feralas" },
			[2] = { str = "Make Camp Mojache your home. Turn in #INTesting the Vessel#, accept #GETHippogryph Muisek#,  #GETImproved Quality#, #GETVengeance on the Northspring# and #GETDark Heart# (Elite)." },
			[3] = { str = "Go do #DOHippogryph Muisek# " },
			[4] = { str = "Hearth back to Camp Mojache, Turn in #INHippogryph Muisek# and accept #GETFaerie Dragon Muisek#." },
			[5] = { str = "Go do #DOFaerie Dragon Muisek#, turn it in, accept #GETTreant Muisek#." },
			[6] = { str = "Go do #DOTreant Muisek#, turn it in, accept #GETMountain Giant Muisek# (Elite)." },
			[7] = { str = "Go accept #GETZapped Giants# at #COORD[44,44]#" },
			[8] = { str = "Do #DOImproved Quality#, #DOPerfect Yeti Hide#, #DOVengeance on the Northspring#, #DODark Heart# (Elite) and #DOMountain Giant Muisek# (Elite) along with #DOZapped Giants#" },
			[9] = { str = "Once those quests are completed and #INZapped Giants# is turned in, hearth to Camp Mojache." },
			[10] = { str = "Turn in #INMountain Giant Muisek# (Elite), accept #GETWeapons of Spirit#, then turn it in complete it." },
			[11] = { str = "Turn in #INImproved Quality#, #INPerfect Yeti Hide#, #INVengeance on the Northspring# and #INDark Heart# " },
			[12] = { str = "Accept #GETThe Strength of Corruption# " },
	...
	[4950] = {
		...
		items = {
			...
			[6] = { str = "Do #DOThe Dunemaul Compound# along with #DOGahz'ridian# at #COORD[46,66]# and #COORD[40,73]#, #NPCGor'marok# is in the cave at #COORD[40,58]#", x = 40, y = 58, zone = "Tanaris" },
			...
			[10] = { str = "Then turn in #INTooga's Quest# along with #INScreecher Spirits# " },
			...
			[12] = { str = "Get your #ITEM[Sampling Kit]# from the bank and go do #DOTanaris Field Sampling#, turn in #INGahz'ridian# at #COORD[52,45]#.", x = 52, y = 45, zone = "Tanaris" },
			[13] = { str = "#DOThe Scrimshank Redemption#, in the cave at #COORD[53,70]# The secret for finding the item for this quest is keep making right turns in the cave and it will lead you to it. ", x = 53, y = 70, zone = "Tanaris" },
			...
			[16] = { str = "Turn in #INTanaris Fiels Sampling#, accept #GETReturn to Apothecary Zinge#." },
