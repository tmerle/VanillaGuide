...
-----------42-43 Stranglethorn Vale
	...
	[4243] = {
		...
		items = {
			...
			[3] = { str = "02) fly to BB" },
			[4] = { str = "03) accept ALL quests in BB: #ACCEPT\"The Bloodsail Buccaneers\"# #ACCEPT\"Up to Snuff\"# #ACCEPT\"Fool's Stout\"# #ACCEPT\"Akiris by the Bundle\"# #ACCEPT\"Voodoo Dues\"# #ACCEPT\"Stoley's Debt\"# #ACCEPT\"Stranglethorn Fever\"# and #ACCEPT\"Keep An Eye Out\"#" },
