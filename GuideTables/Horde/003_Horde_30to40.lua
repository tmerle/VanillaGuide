...
Table_003_Horde_30to40 = {
   [3029] = {
      ...
      items = {
         ...
         [2] = { str = "Do #DOID501#, killing the level 32-34 #NPCID2405# on the plateaus." },
         [3] = { str = "Charge the third flame #ITEMFlame of Uzel#, for the quest #DOID552# " },
         [4] = { str = "Kill #NPCID4503# (level 37 mob), it's a tough battle so prepare yourself! A group may be needed." },
   ...
   [3031] = {
      ...
      items = {
         ...
         [5] = { str = "#DOID185#, #NPCID680# at #COORD[33,10]#", x = 33, y = 10, zone = "Stranglethorn Vale" },
         [6] = { str = "#DOID190#, #NPCID682# at #COORD[41.09]#", x = 41, y = 9, zone = "Stranglethorn Vale" },
         [7] = { str = "#DOID190#, #NPCID735# at #COORD[30,11]#", x = 30, y = 11, zone = "Stranglethorn Vale" },
         [8] = { str = "#DOID185#, #NPCID681# at #COORD[30,10]#", x = 30, y = 11, zone = "Stranglethorn Vale" },
         [9] = { str = "#DOID194#, #NPCID684# at #COORD[25,15]#", x = 25, y = 15, zone = "Stranglethorn Vale" },
         [10] = { str = "Accept #GETID185#, #NPCID1084#, but don't do it now." },
         [11] = { str = "Accept #GETID194#, #NPCID685#, but don't do it now." },
   ...
   [3132] = {
      ...
      items = {
         ...
         [8] = { str = "Accept #GETID1431# from #NPCID5638# in the Cleft of Shadow, #COORD[47,50]#", x = 47, y = 50, zone = "Orgrimmar" },
         [9] = { str = "Then go to #NPCID5639# in Orgrimmar #COORD[23,53]# to accept #GETID1431# pt.2.", x = 23, y = 53, zone = "Orgrimmar" },
   ...
   [3234] = {
      ...
      items = {
         ...
         [18] = { str = "Turn those in at #NPCID11316# for 2 #ITEMID13545#." },
         [19] = { str = "Travel up the water, collecting #ITEMID15923# for the quest #DOID6142# along the way" },
         [20] = { str = "Accept #GETID6161# at the chest/wrecked boat along the shore, #COORD[36,30]#. The #ITEMID15878# is dropped by a #NPCID11562#, #NPCID11563#, and the #ITEMID15881# is dropped by a #NPCID4710#.", x = 36, y = 30, zone = "Desolace" },
         [21] = { str = "Go accept #GETID5741# from #NPCID11862# at #COORD[38,27]#", x = 38, y = 27, zone = "Desolace" },
         [22] = { str = "Then go to Thunder Axe Fortress #COORD[54,29]# and do #DOID1435#, #DOID5741# and #DOID5381#.", x = 54, y = 29, zone = "Desolace" },
         [23] = { str = "Grind your way back to #NPCID11862# #COORD[38,27]#, turn in #INID5741# in and get #GETID6027#.", x = 38, y = 27, zone = "Desolace" },
   ...
   [3435] = {
      ...
      items = {
         ...
         [2] = { str = "Turn in #INID1178# pt.2, accept #GETID1178# pt.3 Make Booty Bay your home! Accept #GETID605#, #GETID189#, #GETID213# and #GETID201#. Turn in #INID1178# pt.3 at #NPCID2495#, accept #GETID1178# pt.4." },
         ...
         [7] = { str = "Do #DOID185#, killing #NPCID1084# at #COORD[31,19]#", x = 31, y = 19, zone = "Stranglethorn Vale" },
         [8] = { str = "Do #DOID189#, #DOID581# and #DOID596# (no need to complete latter at this time)." },
         [9] = { str = "Do #DOID194# and #DOID568# killing #NPCID685# just outside Grom'gol." },
         ...
         [14] = { str = "Do #DOID185# killing #NPCID728#, he is usually on top of the hill at #COORD[31,17]#. Go turn it in when done.", x = 31, y = 17, zone = "Stranglethorn Vale" },
         [15] = { str = "Do #DOID213# along with #DOID1178# at #COORD[44,19]#", x = 44, y = 19, zone = "Stranglethorn Vale" },
         [16] = { str = "Do #DOID190# along with #DOID570#, kill #NPCID683# at #COORD[48,21]#", x = 48, y = 21, zone = "Stranglethorn Vale" },
         [17] = { str = "Do #DOID568# pt.2 at #COORD[36,30]#", x = 36, y = 30, zone = "Stranglethorn Vale" },
         [18] = { str = "Head up north and turn in #INID190#,accept #GETID190#, #NPCID727#, but don't do it now." },
   ...
   [3537] = {
      ...
      items = {
         ...
         [13] = { str = "Do #DOID677# pt.2 killing #NPCOgre#, and #DOID701# killing #NPCID2560# around #COORD[50,75]#", x = 50, y = 75, zone = "Arathi Highlands" },
   ...
   [3736] = {
      ...
      items = {
         ...
         [8] = { str = "Once in Orgrimmar, turn in #INID1431# at #NPCID5639# at #COORD[21,53]#", x = 21, y = 53, zone = "Orgrimmar" },
   ...
   [3840] = {
      ...
      items = {
         ...
         [5] = { str = "Do #DOID194# along with #DOID570# at #COORD[31,41]#, kill #NPCID686#.", x = 31, y = 41, zone = "Stranglethorn Vale" },
         ...
         [9] = { str = "Do #DOID190#, kill #NPCID727# (he has 3 different spawn points, #COORD[48,20]#, #COORD[49,23]#, and #COORD[47,26]#)", x = 48, y = 20, zone = "Stranglethorn Vale" },
         [10] = { str = "Turn in #INID190# and #INID194# at Nesingwary's Expedition #COORD[35,10]#", x = 35, y = 10, zone = "Stranglethorn Vale" },
         [11] = { str = "Accept #GETID194# for #NPCID729#, but don't do it now." },
         ...
         [15] = { str = "Run back to Booty Bay, turn in #INID606#, accept #GETID607#, turn in #INID595#, accept #GETID595# pt.2, turn in #INID607#, then turn in #INID595# at #NPCID2486#." },
