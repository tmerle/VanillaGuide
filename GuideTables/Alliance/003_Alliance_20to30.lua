...
Table_003_Alliance_20to30 = {
   [2021] = {
      ...
      items = {
         ...
         [4] = { str = "Go to #COORD[39,85]# it should say you found #DOID944# now use the #ITEM[Phial of Scrying]#. Click it turn in #INID944# accept #GETID949#", x = 39, y = 85, zone = "Darkshore" },
         [5] = { str = "Click the #ITEM[Book]# at #COORD[38,86]# turn in #INID949# accept #GETID950#.", x = 38, y = 86, zone = "Darkshore" },
   ...
   [2223] = {
      ...
      items = {
         ...
         [9] = { str = "Run to 37,8 turn in #INID1056# SKIP #VIDEOReclaiming The Charred Vale# for now", x = 37, y = 8, zone = "Stonetalon Mountains" },
   ...
   [2425] = {
      ...
      items = {
         ...
         [6] = { str = "Grind a path up to between #COORD[35,33]# and #COORD[36,36]# (he patrols) and kill #NPCDal Bloodclaw# for #DOID1054#.", x = 35, y = 33, zone = "Ashenvale" },
   ...
   [2526] = {
      ...
      items = {
         ...
         [10] = { str = "Buy a #NPCFlagon of Mead# from the bartender for #DOID288# and give it to the guy outside the inn. Accept #GETID289#" },
         ...
         [42] = { str = "Stop at the sunken ships around #COORD[14,28]# #COORD[14,25]# and kill the undead on either ship for #DOID289# Try to stay on top of the ships. Kill #NPCSnellig# in the broken part of the first ship in the rear near the shore for the box.", x = 14, y = 28, zone = "Wetlands" },
