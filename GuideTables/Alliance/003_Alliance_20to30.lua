...
-----------20-21 Darkshore
    ...
    [2021] = {
        ...
        items = {
            ...
            [4] = { str = "Go to #COORD[39,85]# it should say you found #DOMaster’s Glaive(complete)# now use the Phial of Scrying. Click it turn in  #INThe Master's Glaive#  accept  #GETThe Twilight Camp#", x = 39, y = 85, zone = "Darkshore" },
            [5] = { str = "Click the Book at #COORD[38,86]# turn in  #INThe Twilight Camp#  accept  #GETReturn to Onu#.", x = 38, y = 86, zone = "Darkshore" },
