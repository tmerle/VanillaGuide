...
Table_003_Alliance_20to30 = {
   ...
   [2122] = {
      ...
      items = {
         ...
         [2] = { str = "Run to #COORD[26,36]# Maestra's Post in Ashenvale, and this will complete #DOID5321# Go turn it in straight ahead in the house.", x = 26, y = 36, zone = "Ashenvale" },
         [3] = { str = "Accept #GETID1010#." },
         [4] = { str = "Kill mobs around #COORD[31,31]# in ruins of Ordil'Aran for #DOID970# pt.4 I then clear the camp a total of 4 times. If I find it early I still clear it 4 times total. I am then half way to level 22.", x = 31, y = 31, zone = "Ashenvale" },
         [5] = { str = "Grab plant bundles for #DOID1010# at #COORD[31,21]# in Bathran's Haunt", x = 31, y = 21, zone = "Ashenvale" },
