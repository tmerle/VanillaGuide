...
Table_003_Alliance_30to40 = {
   ...
   [3637] = {
      ...
      items = {
         ...
         [6] = { str = "Grind your way west to to the house at #COORD[39,16]# and kill #NPCNagaz# for #DOID537#. I take out the first camp you come across then grind anything in my way west that’s not in a camp. ", x = 39, y = 16, zone = "Alterac Mountains" },
   ...
   [3738] = {
      ...
      items = {
         ...
         [11] = { str = "Go do #DOID693# by killing #NPCColdrage# in the cave at #COORD[53,77]# (follow the left path) run back to Refuge hand it in, SKIP the rest", x = 53, y = 77, zone = "Arathi Highlands" },
