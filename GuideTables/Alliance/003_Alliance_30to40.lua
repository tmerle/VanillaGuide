...
Table_003_Alliance_30to40 = {
   ...
   [3031] = {
      ...
      items = {
         ...
         [9] = { str = "Go just SW of Southshore and do #DODown the Coast# on the shore, killing murlocs. Turn it in at the Inn when you’re done, accept #GETID559# pt.1" },
   ...
   [3131] = {
      ...
      items = {
         ...
         [3] = { str = "Go east of AV and do #DOSyndicate Assassins# at the camp around #COORD[55,67]#. There is a camp close to AV but this one has a quest you can grab near the tents on the table. Clear the camp and touch the syndicate document, accept #GETID510# and #GETID511#", x = 55, y = 67, zone = "Alterac Mountains" },
         [4] = { str = "Hearth to Southshore" },
         [5] = { str = "Go into the town hall, turn in #INSyndicate Assassins# and #INForeboding Plans# accept #GETID512#" },
         [6] = { str = "Stop at the house North of the Inn, turn in #INEncrypted Letter# accept #GETID514#" },
   ...
   [3132] = {
      ...
      items = {
         ...
         [4] = { str = "Go to the hall of explorers at #COORD[69,20]# in IF accept #GETID1453# in Desolace then go turn in #INLetter to Stormpike# accept #GETID525#", x = 69, y = 20, zone = "Arathi Highlands" },
   ...
   [3232] = {
      ...
      items = {
         ...
         [15] = { str = "Turn in #INKrazek's Cookery# on the top floor of the inn, accept and hand back in (the bloodstone ores) #GETID627# then accept #GETID622# (this quest gives you your first helm) also accept #GETID201# and #GETID198#" },
   ...
   [3233] = {
      ...
      items = {
         ...
         [4] = { str = "Go to #COORD[78,77]# and turn in #INThe Brassbolts Brothers# accept #GETID1105# and #GETID1104#", x = 78, y = 77, zone = "Thousand Needles" },
         ...
         [15] = { str = "Go to the 2 npc’s next east of here and hand in #INSalt Flat Venom# and #INHardened Shells# then accept #GETID1106#" },
         [16] = { str = "Run east to #COORD[80,75]# turn in #INLoad Lightening# accept #GETID1178# pt.1", x = 80, y = 75, zone = "Thousand Needles" },
   ...
   [3335] = {
      ...
      items = {
         ...
         [4] = { str = "Go south of the Inn, hand in #INReclaimers' Business# in Desolace accept #GETID1458# pt.1 and #GETID1454# pt.1" },
         ...
         [26] = { str = "Run back to #COORD[38,27]# and turn in #INSceptre of Light# accept #GETID6027#", x = 38, y = 27, zone = "Desolace" },
         ...
         [37] = { str = "Go to the engineer hut at #COORD[62,36]# and hand in #INID1178# pt.1 accept #GETID1180# pt.2 Then run out on the dock and hand in #INWharfmaster Dizzywig# accept #GETID1112#", x = 62, y = 36, zone = "Desolace" },
   ...
   [3536] = {
      ...
      items = {
         ...
         [8] = { str = "Run west to the Venture Co. Base Camp at #COORD[43,18]# and Kill the goblins here for #DOHostile Takeover# while you climb the Operations Tower behind the base for #DOID1182# pt.4 You’re going to climb it and kill Foreman Cozzle for his key.", x = 43, y = 18, zone = "Stranglethorn Vale" },
         ...
         [13] = { str = "Go to Nessingways and turn in #INID187# pt.3, #INID192# pt.3, #INID195# pt.2, and #INHemet Nesingwary#, Accept #GETID188# pt.4 #GETID193# pt.4 and #GETID196# pt.3" },
         ...
         [15] = { str = "Go up to the rebel camp at 37,3 and hand in #INSupplies to Private Thorsen#, If he’s not here look south of the camp, if you save him when he patrols you can also get #GETID215# then u turn that in at the camp and get #GETID200#", x = 37, y = 3, zone = "Stranglethorn Vale" },
         [16] = { str = "Hand in #INReturn to Corporal Kaleb# get your helm" },
         [17] = { str = "Accept #GETID574#" },
         [18] = { str = "Go to the Inn looking building at #COORD[43,9]# touch the book on the 2nd floor and hand in #INBookie Herod# accept #GETID328#", x = 43, y = 9, zone = "Stranglethorn Vale" },
         [19] = { str = "Go in the cave at #COORD[45,7]# and kill the mobs in here for #DOSpecial Forces# and make your way to the chest for #DOBookie Herod# , it’s down the first fork, only 1 level down then in the boxes. Accept #GETID329# (Easy from here)", x = 45, y = 7, zone = "Stranglethorn Vale" },
         ...
         [22] = { str = "Hand in #INThe Spy Revealed!# accept #GETID330# turn around and hand that in and accept #GETID331# then turn around again and hand that back in (told you it was easy)" },
         ...
         [31] = { str = "Go just outside, turn in #INThe Stone of the Tides# and #INID1182# pt.4 Accept #GETID601# and #GETID1183# pt.5" },
         [32] = { str = "Go into the shop Tan-Your-Hide Leatherworks and turn in #INSupply and Demand# (it’s down the ramp from the FP) accept #GETID577#" },
         ...
         [36] = { str = "Run out to Shimmering Flats at #COORD[77,77]# and turn in #INParts for Kravel# accept #GETID1114# then turn around and hand it in", x = 77, y = 77, zone = "Stranglethorn Vale" },
   ...
   [3637] = {
      ...
      items = {
         ...
         [2] = { str = "Go to the Town Hall and turn in #INFurther Mysteries# accept #GETID537# and #GETID512#" },
   ...
   [3738] = {
      ...
      items = {
         ...
         [4] = { str = "Go just east of Hammerfall to #COORD[80,40]#. (Load up on bloodstone ore here, you can sell it for a few g per 4 in BB) This is a tree, behind it is the path up to the cave to kill kobolds for #DOThe Princess Trapped# If you get them all before the end of the cave you have to continue to the end to hand it in by touching Iridescent Shards and accept #GETID651#", x = 80, y = 40, zone = "Arathi Highlands" },
         ...
         [10] = { str = "Go to refuge point and hand in #INWorth Its Weight In Gold# this opens up #GETID693# from another NPC" },
         ...
         [20] = { str = "Go down south near the sunken ships, around #COORD[24,84]# and do #DOID666# pt.2 (use goggles to find them easy), #DODrowned Sorrows# (nagas), and #DODeep Sea Salvage# (2 on each ship)", x = 24, y = 84, zone = "Arathi Highlands" },
         [21] = { str = "Turn in #INDeep Sea Salvage# on the dock" },
         [22] = { str = "Turn in #INDrowned Sorrows# next to the fire, then #INID666# pt.2 accept #GETID668# pt.3" },
   ...
   [3838] = {
      ...
      items = {
         ...
         [14] = { str = "Turn in #INMudrock Soup and Bugs# in front of you, accept #GETID1258#" },
         [15] = { str = "Go to the docks at the tower and turn in #INThe Orc Report# accept #GETID1220# Run in the castle behind the Inn and turn it in" },
         ...
         [29] = { str = "Fly to Gadgetzan and run up to the Shimmering Flats to #COORD[80,76]# turn in #INRazzeric's Tweaking# accept #GETID1188# pt.1 turn it in in Gadget and accept #GETID1189# pt.2 then run back to the flats and hand it in", x = 80, y = 76, zone = "Dustwallow Marsh" },
   ...
   [3840] = {
      ...
      items = {
         ...
         [5] = { str = "Go upstairs, turn in #INThe Rumormonger# accept #GETID1116# and #GETID209#" },
         ...
         [17] = { str = "Go into the shop Tan-Your-Hide Leatherworks and turn in #INSome assembly required# accept #GETID628#" },
         ...
         [21] = { str = "Turn right after the tunnel, turn in #INScaring Shaky# accept #GETID607#" },
         [22] = { str = "Follow the lower dock towards the Inn, turn in #INID597# pt.2 accept #GETID599# pt.3" },
         [23] = { str = "Go In the house across from the half ship, turn in #INReturn to MacKinley# accept #GETID609#" },
