...
-----------37-38 Arathi Highlands
	...
	[3738] = {
	    ...
	    items = {
			...
			[25] = { str = "Escort her when done turn it back in  and accept #GET“Hints of a New Plague? Pt.5”# Grind until youre 3500 xp to level 38" },
			[26] = { str = "Hearth to Southshore" },
			[27] = { str = "Turn in #IN“Hints of a New Plague? Pt.5”# just outside the Inn" },
...
-----------38-38 Dustwallow Marsh
	...
	[3838] = {
		...
		items = {
			...
			[2] = { str = "Run up near the Inn, accept #GET“They Call Him Smiling Jim”#" },
			[3] = { str = "Go in the Inn, accept #GET“Mudrock Soup and Bugs”# and make Theramore your home. " },
			[4] = { str = "Go to the 2nd floor of the castle behind the Inn, not the tower, turn in #IN“They Call Him Smiling Jim”# This gives you hints about some quests at the old Inn near the Barrens." },
			...
			[6] = { str = "Just as you exit Theramore, go right and kill Mudrock turtles along the shore for #DO“Mudrock Soup and Bugs”#" },
			[7] = { str = "Go to the house at #COORD[55,26]# and accept #GET“Soothing Spices”# then turn it right back in, accept #GET“Jarl Needs eyes”#", x = 55, y = 26, zone = "Dustwallow Marsh" },
			[8] = { str = "Touch the mound of dirt beside the house, accept #GET“The Orc Report”#" },
			[9] = { str = "Run over to Darkmist Cavern at #COORD[32,23]# and kill spiders inside and outside for #DO“Jarl Needs eyes”# They drop 1-2 every kill", x = 32, y = 23, zone = "Dustwallow Marsh" },
			[10] = { str = "Stop at #COORD[35,38]# and grab #GET“Hungry!”#", x = 35, y = 38, zone = "Dustwallow Marsh" },
			[11] = { str = "Go to #COORD[29,47]#, the shady rest inn, and grab these 3 quests, touch the hoofprints just out front #GET“Suspicious Hoofprints”# the badge on the board laying on the floorboards (it’s a tiny badge) #GET“Lieutenant Paval Reethe pt.1”# and the shield over the fireplace #GET“The Black Shield pt.1”# ", x = 29, y = 47, zone = "Dustwallow Marsh" },
			[12] = { str = "Run over to #COORD[54,56]# and open the shipping crate for #DO“Razzeric's Tweaking”#", x = 54, y = 56, zone = "Dustwallow Marsh" },
			[13] = { str = "Hearth to Theramore" },
			[14] = { str = "Turn in #IN“Mudrock Soup and Bugs”# in front of you, accept #GET“… and bugs”#" },
			[15] = { str = "Go to the docks at the tower and turn in #IN“The Orc Report”# accept #GET“Captain Vimes”# Run in the castle behind the Inn and turn it in" },
			[16] = { str = "Turn in #IN“Lieutenant Paval Reethe pt.1”# accept #GET“Lieutenant Paval Reethe pt.2”#" },
			[17] = { str = " Turn in #IN“The Black Shield pt.1”# accept #GET“The Black Shield pt.2”#" },
			[18] = { str = "Turn in #IN“Suspicious Hoofprints”# accept the next quest " },
			[19] = { str = "Turn around and hand in #IN“Lieutenant Paval Reethe pt.2”# accept #GET“Daelin's Men”# then turn around hand it in accept #GET“The Deserters pt.1”#" },
			[20] = { str = "Go to the blacksmith house, turn in #IN“The Black Shield pt.2”# accept #GET“The Black Shield pt.3”# go turn it in back up in the castle" },
			[21] = { str = "Run out to #COORD[55,26]# and turn in #IN“Jarl Needs eyes”# SKIP the next", x = 55, y = 26, zone = "Dustwallow Marsh" },
			[22] = { str = "Go just NE of here and kill murlocs for #DO“Hungry!”#" },
			[23] = { str = "Stop at #COORD[46,17]# and clear some raptors until you’re 50% or more into 39, then accept #GET“Stinky's Escape”# just follow him, and kill what attacks him. Really easy.", x = 46, y = 17, zone = "Dustwallow Marsh" },
			[24] = { str = "Stop at #COORD[35,38]# turn in #IN“Hungry!”#", x = 35, y = 38, zone = "Dustwallow Marsh" },
			[25] = { str = "Go to the tower at #COORD[35,53]# and attack Balos Jacken, at ¼ life he’ll become friendly and then turn in #IN“The Deserters pt.1”# accept #GET“The Deserters pt.2”#", x = 35, y = 53, zone = "Dustwallow Marsh" },
			[26] = { str = "Die so you end up near Theramore" },
			[27] = { str = "Turn in #IN“Stinky's Escape”# in the Inn " },
			[28] = { str = "Go up in the castle, turn in #IN“The Deserters pt.2”#" },
			[29] = { str = "Fly to Gadgetzan and run up to the Shimmering Flats to #COORD[80,76]# turn in #IN“Razzeric's Tweaking”# accept #GET“Safety First pt.1”# turn it in in Gadget and accept #GET“Safety First pt.2”# then run back to the flats and hand it in", x = 80, y = 76, zone = "Dustwallow Marsh" },
...
-----------38-40 Stranglethorn Vale
	...
	[3840] = {
		...
		items = {
			...
			[2] = { str = "Run towards the Inn, accept #GET“The Bloodsail Buccaneers pt.1”# halfway" },
			[3] = { str = "Go in the building next to the half boat upside down, accept #GET“Scaring Shaky”#" },
			[4] = { str = "Go in the Inn, make it your home, accept #GET“Venture Company Mining”#" },
			[5] = { str = "Go upstairs, turn in #IN“The Rumormonger”# accept #GET“Dream Dust In the Swamp”# and #GET“Skullsplitter Tusks”#" },
			[6] = { str = "Go just outside, hand in #IN“Sunken Treasure pt.4”# SKIP the next" },
			[7] = { str = "Go to around #COORD[33,39]# and kill raptors for  #DO“Raptor Mastery pt.3”#", x = 33, y = 39, zone = "Stranglethorn Vale" },
			[8] = { str = "Kill Snapjaw Crocolisks from the stream at #COORD[38,30]# to the lake at #COORD[41,19]# for #DO“Some assembly required”#", x = 38, y = 30, zone = "Stranglethorn Vale" },
			[9] = { str = "Go to the Island at #COORD[20,23]# and kill elementals for #DO“Water Elementals”# You should be close to level 39 by now, either grind on the elementals or raptors and basalisks around #COORD[33,39]#", x = 20, y = 23, zone = "Stranglethorn Vale" },
			[10] = { str = "Once you’re level 39, grind your way east to the road then to #COORD[41,41]# and kill the goblins for #DO“Venture Company Mining”#", x = 41, y = 41, zone = "Stranglethorn Vale" },
			[11] = { str = "Run up to the camps around #COORD[42,37]# and do #DO“Skullsplitter Tusks”#", x = 42, y = 37, zone = "Stranglethorn Vale" },
			[12] = { str = "Now you’re gonna have to find Bhag'thera for #DO“Panther Mastery pt.4”# she is anywhere between just north of Mosh’ogg at #COORD[49,25]# to just north of the ZG entrance at #COORD[48,17]# she’s elite. Easy way to do it is lay immolation trap and run her into it, once pet gets half health fear it and keep attacking it", x = 48, y = 25, zone = "Stranglethorn Vale" },
			[13] = { str = "Hearth back to BB" },
			[14] = { str = " Turn in #IN“Venture Company Mining”#" },
			[15] = { str = "Go upstairs, turn in #IN“Skullsplitter Tusks”#" },
			[16] = { str = "Walk outside, turn in #IN“Water Elementals”# SKIP the next" },
			[17] = { str = "Go into the shop Tan-Your-Hide Leatherworks and turn in #IN“Some assembly required”# accept #GET“Excelsior”#" },
			[18] = { str = "Go out of BB and turn left to the camp of pirates at #COORD[27,69]# and touch the letter on the barrel, turn in #IN“The Bloodsail Buccaneers pt.1”# accept #GET“The Bloodsail Buccaneers pt.2”#", x = 27, y = 69, zone = "Stranglethorn Vale" },
			[19] = { str = "Go kill gorillas around #COORD[32,65]# just NE of BB for #DO“Scaring Shaky”#", x = 32, y = 65, zone = "Stranglethorn Vale" },
			[20] = { str = "Run back to BB" },
			[21] = { str = "Turn right after the tunnel, turn in #IN“Scaring Shaky”# accept #GET“Return to MacKinley”#" },
			[22] = { str = "Follow the lower dock towards the Inn, turn in #IN“The Bloodsail Buccaneers pt.2”# accept #GET“The Bloodsail Buccaneers pt.3”#" },
			[23] = { str = "Go In the house across from the half ship, turn in #IN“Return to MacKinley”# accept #GET“Voodoo Dues”#" },
			[24] = { str = "Go up top the Inn, accept #GET“Up To Snuff”#" },
			[25] = { str = "Go just outside, turn in #IN“The Bloodsail Buccaneers pt.3”# accept #GET“The Bloodsail Buccaneers pt.4”#" },
			...
			[27] = { str = "Go up near Grom’Gol, search the shore there for the 38 elite croc for #DO“Excelsior”# stay away from the base or the guards will get you" },
			[28] = { str = "Run up to Nessingways at #COORD[35,10]# and turn in #IN“Raptor Mastery pt.3”# and #IN“Panther Mastery pt.4”#  accept #GET“Raptor Mastery pt.4”#", x = 35, y = 10, zone = "Stranglethorn Vale" },
			[29] = { str = "Accept #GET“The Green Hills of Stranglethorn”# then turn it in" },
			...
			[31] = { str = "Hearth to BB" },
			[32] = { str = "Go into the shop Tan-Your-Hide Leatherworks and turn in #IN“Excelsior”#" },
			[33] = { str = "Now fly to IF and accept #GET“Ironband Wants You”# from Prospector Stormpike at 74 11, and either to Darnassus to get your new skills and your mount, or get skills in IF and prepare for a few badlands quests by buying a frost oil and a gyrochronatom (don’t by a gyro if you can’t find a frost oil) Then a healing potion and lesser invisibility potion. Again don’t get either of the potions if you can’t get a frost oil or gyro.", x = 74, y = 11, zone = "Iron Forge" },
			[34] = { str = "Fly to Loch Modan, Stable your pet, and make Thelsamar your home" },
			[35] = { str = "Go in the house behind the Inn, accept #GET“Badlands Reagent Run”#" },
			[36] = { str = "Run to #COORD[65,65]# and accept #GET“Find Agmond”#", x = 65, y = 65, zone = "Loch Modan" },
