...
Table_002_Teldrassil = {
   [0106] = {
      ...
      items = {
         ...
         [15] = { str = "For #DOID3521# pt.1, get #ITEMWebwood Ichor# from a #NPCWebwood Spider# #COORD[57,32]#. Get #ITEMWebwood Egg# for #DOID917# at #COORD[57,26]# inside the cave.", x = 57, y = 36, zone = "Teldrassil" },
   ...
   [0612] = {
      ...
      items = {
         ...
         [15] = { str = "Do #DOID489# #ITEM(cones under trees)# while heading to #COORD[60,68]# and turn in #INID997#", x = 60, y = 68, zone = "Teldrassil" },
