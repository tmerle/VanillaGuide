...
Table_002_Teldrassil = {
   [0106] = {
      ...
      items = {
         ...
         [2] = { str = "Accept #GETID456# pt.1 from #NPCConservator Ilthalaine# just in front og you, and go do it by killing mobs at #COORD[57,45]# and #COORD[61,43]#.", x = 57, y = 45, zone = "Teldrassil" },
         ...
         [7] = { str = "Accept #GETID916# at #COORD[58,42]#. Go turn in #INEtched Sigil# at your class trainer. Get new skills.", x = 58, y = 42, zone = "Teldrassil" },
         ...
         [10] = { str = "Turn in #INA Good Friend# at #COORD[55,33]# in a cove just west of the cave. Accept #GETID3519#.", x = 55, y = 33, zone = "Teldrassil" },
         [11] = { str = "Turn in #INWebwood Venom# at #COORD[58,42]#. Accept #GETID917#.", x = 58, y = 42, zone = "Teldrassil" },
         [12] = { str = "Turn in #INID457# pt.2 at #COORD[59,44]#", x = 59, y = 44, zone = "Teldrassil" },
         [13] = { str = "Turn in #INA Friend in Need# at #COORD[61,42]#, accept #GETID3521# pt.1", x = 61, y = 42, zone = "Teldrassil" },
         [14] = { str = "Do #DOID3521# pt.1, get #ITEMMoonpetal Lily# and #ITEMHyancinth Mushroom# around #COORD[57,37]#.", x = 57, y = 37, zone = "Teldrassil" },
         [15] = { str = "For #DOID3521# pt.1, get #ITEMWebwood Ichor# from a #NPCWebwood Spider# #COORD[57,32]#. Get #ITEMWebwood Egg# for #DOWebwood Egg# at #COORD[57,26]# inside the cave.", x = 57, y = 36, zone = "Teldrassil" },
         [16] = { str = "Turn in #INWebwood Egg# at #COORD[58,42]# Accept #GETID920#, then run up the ramp to the top of the tree and hand it in at #COORD[59,39]#. Accept #GETID921# pt.1 ", x = 58, y = 42, zone = "Teldrassil" },
         ...
         [19] = { str = "Fill the #ITEM[Crystal Phial]# for #DOID921# pt.1 at #COORD[59,32]#", x = 59, y = 32, zone = "Teldrassil" },
   ...
   [0612] = {
      ...
      items = {
         ...
         [12] = { str = "Turn in #INA Troubling Breeze# at #COORD[66,58]# accept #GETID476#.", x = 66, y = 58, zone = "Teldrassil" },
         [13] = { str = "#DOThe Emerald Dreamcatcher# #COORD[68,59]#", x = 68, y = 59, zone = "Teldrassil" },
         [14] = { str = "Turn in #INZenn's Bidding# at #COORD[60,56]# then go to the Dolanaar tower and accept #GETID489#.", x = 60, y = 56, zone = "Teldrassil" },
         ...
         [19] = { str = "Turn in #INGnarlpine Corruption# accept #GETID483#." },
         [20] = { str = "Turn in #INThe Emerald Dreamcatcher# accept #GETID2459#" },
         ...
         [35] = { str = "Turn in #INThe Relics of Wakening# accept #GETID486#" },
         [36] = { str = "You should be level 10 now, if not grind to it" },
         [37] = { str = "Run to Darnassus and turn in #INRellian Greenspyre# at #COORD[38,21]# accept #GETID923#", x = 38, y = 21, zone = "Teldrassil" },
         ...
         [46] = { str = "Run back to Darnassus, turn in #INTumors# at #COORD[38,21]# accept #GETID2498#.", x = 38, y = 21, zone = "Teldrassil" },
         [47] = { str = "Turn in #INTeldrassil# atop the tower at #COORD[36,12]# accept #GETID952#.", x = 36, y = 12, zone = "Teldrassil" },
         [48] = { str = "Hearth to Dolanaar." },
         [49] = { str = "Turn in #INID934{ pt.5 accept #GETID935# pt.6." },
         [50] = { str = "Turn in #INUrsal the Mauler#." },
         [51] = { str = "Go SE to #COORD[60,68]# Turn in #INReturn to Denalan# accept #GETID2499#.", x = 60, y = 68, zone = "Teldrassil" },
         ...
         [57] = { str = "Run straight ahead to #COORD[56,92]#, turn in #INNessa Shadowsong# accept #GETID6341# go hand it in to the hippogryph guy at #COORD[58,93]# to get a free ride and accept #GETID6342#.", x = 56, y = 92, zone = "Teldrassil" },
