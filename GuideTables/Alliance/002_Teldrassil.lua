...
-----------1-6 Teldrassil
	...
	[0106] = {
		...
		items = {
			...
			[6] = { str = "^_^", x = 58, y = 40, zone = "Teldrassil" },
			[7] = { str = "Jump down and go do the following #DOThe Balance of Nature pt.2#  mobs are all around #COORD[60,35]#", x = 60, y = 35, zone = "Teldrassil" },
			[8] = { str = "#DOWebwood Venom#  at #COORD[57,32]# in and outside the cave.", x = 57, y = 32, zone = "Teldrassil" },
			[9] = { str = "Turn in  #INA Good Friend#  at #COORD[54,32]# in a cove just west of the cave. Accept  #GETA Friend in Need#.", x = 54, y = 32, zone = "Teldrassil" },
			[10] = { str = "Turn in  #INWebwood Venom#  at #COORD[57,41]#. Accept  #GETWebwood Egg#.", x = 57, y = 41, zone = "Teldrassil" },
			[11] = { str = "Turn in  #INThe Balance of Nature pt.2#  at #COORD[58,44]#", x = 58, y = 44, zone = "Teldrassil" },
			[12] = { str = "Turn in  #INA Friend in Need#  at #COORD[60,41]#, accept  #GETIverron's Antidote pt.1#", x = 60, y = 41, zone = "Teldrassil" },
			[13] = { str = "#DOIverron's Antidote pt.1#  (lilies and mushrooms) around #COORD[57,37]#.", x = 57, y = 37, zone = "Teldrassil" },
			[14] = { str = "#DOIverron's Antidote pt.1#  (ichor) in the cave #COORD[57,32]# along with  #DOWebwood Egg#  at #COORD[56,26]#", x = 57, y = 32, zone = "Teldrassil" },
			[15] = { str = "Turn in  #INWebwood Egg#  at #COORD[57,41]# Accept  #GETTenaron's Summons#  then run up the ramp to the top of the tree and hand it in at #COORD[59,39]#. Accept  #GETCrown of the Earth pt.1# ", x = 57, y = 41, zone = "Teldrassil" },
			[16] = { str = "Turn in  #INIverron's Antidote pt.1#  accept  #GETIverron's Antidote pt.2#." },
			[17] = { str = "Do  #DOCrown of the Earth pt.1#  at #COORD[59,32]#", x = 59, y = 32, zone = "Teldrassil" },
			[18] = { str = "Turn in  #INIverron's Antidote pt.2#  at #COORD[54,32]#", x = 54, y = 32, zone = "Teldrassil" },
			[19] = { str = "Turn in  #INCrown of the Earth pt.1#  at #COORD[59,39]# Accept  #GETCrown of the Earth pt.2# ", x = 59, y = 39, zone = "Teldrassil" },
...
-----------6-12 Teldrassil
	...
	[0612] = {
		...
		items = {
			...
			[15] = { str = "Do  #DOSeek Redemption!#  (cones under trees) while heading to #COORD[60,68]# and turn in  #INDenalan's Earth#", x = 60, y = 68, zone = "Teldrassil" },
			...
			[26] = { str = "Turn in  #INFerocitas the Dream Eater#  &  #INTwisted Hatred at Dolanaar#." },
