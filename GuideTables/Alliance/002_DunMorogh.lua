...
Table_002_DunMorogh = {
   [0106] = {
      ...
      items = {
         ...
         [3] = { str = "Go south around #COORD[28,73]# and kill #NPCWolves# for the #ITEM[Tough Wolf Meat]# then go back to #COORD[29,71]# and turn in #INID179# then accept #GET3109# and #GETID233# ", x = 29, y = 71, zone = "Dun Morogh" },
         [4] = { str = "To your left accept #GETID170# " },
         [5] = { str = "At #COORD[30,74]# kill #NPCBurly Troggs# and at #COORD[26,72]# there is a camp of #NPCRockjaw Troggs#, kill them for #DOID170# ", x = 26, y = 72, zone = "Dun Morogh" },
         ...
         [10] = { str = "Just behind him start killing #NPCSmall Crag Boar# until you have 12 for #DOID183# then go back to #COORD[22,71]# and turn it in" },
         ...
         [14] = { str = "At #COORD[26,79]# clear in front of the cave and grab #ITEMFelix's Bucket of Bolts# for #DOID3361# then kill the #NPCFrostmane Troll Whelp# in and out of it until you complete #DOID182#", x = 26, y = 79, zone = "Dun Morogh" },
         ...
         [16] = { str = "Go back in the cave at #COORD[26,79]# and go left at the 3 directions to #COORD[30,80]# and kill #NPCGrik'nir the Cold# for #DOID218# ", x = 30, y = 80, zone = "Dun Morogh" },
   ...
   [0612] = {
      ...
      items = {
         ...
         [6] = { str = "Go to the Innkeeper, make it your home and purchase a #NPCRhapsody Malt# for #DOID384#" },
         ...
         [13] = { str = "From around this camp to the SW kill #NPCBoars# and #NPCBears# until you finish #DOID317# and #DOID384#" },
         [14] = { str = "If you’re having trouble finding #NPCBoars#, just go to around #COORD[40,65]# there are a lot. ", x = 40, y = 65, zone = "Dun Morogh" },
         [15] = { str = "Go into the Grizzled Den at #COORD[42,54]# and kill #NPCWendingos# until you get 8 manes for #DOID313#", x = 42, y = 54, zone = "Dun Morogh" },
         ...
         [25] = { str = "To the North/NE from here you’ll find tons of #NPCBears#, #NPCLeopards#, and #NPCBoars# to kill for #DOID319# You should ding level 8 while killing for this. " },
         [26] = { str = "Kill #NPCFrostmane Seer# and open baskets at #COORD[41,44]# and #COORD[41,35]# for #DOID315#.", x = 41, y = 44, zone = "Dun Morogh" },
         [27] = { str = "Die so you end up in Kharanos" },
         [28] = { str = "Next to the GY accept #GETID287#" },
         [29] = { str = "Go into the Inn and buy a #NPCThunder Ale# off the #NPCInnkeeper# and down in the basement, give the ale to #NPCJarven Thunderbrew#. When he leaves touch the barrel to turn in #INID310# accept #GETID311#. " },
         ...
         [33] = { str = "Go west of Brewnall and kill #NPCLeper Gnomes# until you complete #DOID412# you should hit level 9 getting kills " },
         ...
         [50] = { str = "Go south to the Fargodeep Mine at #COORD[39,82]# and kill #NPCKobold# until you complete all 3 quests #DOID62#, #DOID47#, and #DOID60# Make sure you go in the lower entrance so #DOID62# is easier ", x = 39, y = 82, zone = "Elwynn Forest" },
         ...
         [52] = { str = "Go east to the Maclure Vinyard st #COORD[43,85]# and turn in #INID85# accept #GETID86# then turn around and kill #NPCBoars# until it’s finished ", x = 43, y = 85, zone = "Elwynn Forest" },
         ...
         [68] = { str = "Kill #NPCTroggs# from #COORD[27,53]# and north for #DOID217# and #DOID267#", x = 27, y = 53, zone = "Loch Modan" },
