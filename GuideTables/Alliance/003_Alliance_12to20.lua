...
Table_003_Alliance_12to20 = {
   [1214] = {
      ...
      items = {
         ...
         [7] = { str = "Go do #DOID3524# pt.1 at #COORD[36,50]# grind from town to there to get #ITEM[Crawler Legs]# for #DOID983#.", x = 36, y = 50, zone = "Darkshore" },
         ...
         [22] = { str = "Fill the #ITEM[Empty Water Tube]# in the Moonwell for #DOID4812#, turn in #INID2118#, accept #GETID2138#, turn in #INID984# pt.1 accept #GETID985# Pt.2 and #GETID4761#. Accept #GETID965# pt.1 upstairs." },
   ...
   [1417] = {
      ...
      items = {
         ...
         [3] = { str = "Kill #NPCMoonstalkers# and #NPCRabid Thistle Bears# all around #COORD[48,30]#, for #DOID2138# and #DOID1002#, then head to #COORD[50,25]# for #DOID4762#.", x = 50, y = 25, zone = "Darkshore" },
         ...
         [11] = { str = "Kill #NPCGrizzled Thistle Bear# south of Grove of the Ancients for #DOID1003# then turn it in at #COORD[41,81]#.", x = 41, y = 81, zone = "Darkshore" },          
         ...
         [17] = { str = "Pick up #ITEM[Grains]# for #DOID4763# at #COORD[50,35]#.", x = 50, y = 35, zone = "Darkshore" },
         [18] = { str = "Go do #DOID2139# at #COORD[52,37]#.", x = 52, y = 37, zone = "Darkshore" },
         [19] = { str = "Get #ITEM[Nuts]# at #COORD[52,34]#, and #ITEM[Fruit]# at #COORD[52,33]# for #DOID4763#.", x = 52, y = 34, zone = "Darkshore" },
         ...
         [24] = { str = "Do #DOID1138# at the #NPCCrawlers# here." },
   ...
   [1718] = {
      ...
      items = {
         ...
         [3] = { str = "Run to the Cave at #COORD[35,18]# and do #DOID307#, #ITEM[Miner's Gear]# are looted from the ground. Turn it in back at the bunker.", x = 35, y = 18, zone = "Loch Modan" },
         ...
         [9] = { str = "Do #DOID257# by killing #NPCMountain Buzzard# in front of the house." },
         [10] = { str = "Turn in #INID257# accept #GETID258#. Kill #NPCElder Mountain Boar# at around #COORD[76,46]#.", x = 76, y = 46, zone = "Loch Modan" },
         ...
         [13] = { str = "Get all the parts for #DOID2038#. #ITEM[Blastencapper]# at #COORD[54,27]#, #ITEM[Wrench]# at #COORD[49,30]#, #ITEM[Hammer]# at #COORD[52,24]#, and #ITEM[Screwdriver]# at #COORD[48,21]#.", x = 54, y = 27, zone = "Loch Modan" },
   ...
   [1820] = {
      ...
      items = {
         ...
         [7] = { str = "Get 5 #ITEM[Great Goretusk Snouts]# for #DOID92# just west of the houses. Beware #NPCBellygrub#. Loot #ITEM[Hillary's Necklace]# from the #ITEMGlinting Mud Pile# underwater at #COORD[19,52]#.", x = 19, y = 52, zone = "Redridge Mountains" },
         [8] = { str = "Head towards #COORD[42,55]# for #DOID125# and #DOID127#. Save at least 8 #ITEM[Murloc Fins]# for a later quest.", x = 42, y = 55, zone = "Redridge Mountains" },
         ...
         [11] = { str = "Kill #NPCSpiders# for #DOID92# between #COORD[15,71]# and #COORD[33,76]#.", x = 33, y = 76, zone = "Redridge Mountains" },
         [12] = { str = "Do #DOID246# at #COORD[31,84]# and #COORD[43,72]#.", x = 43, y = 72, zone = "Redridge Mountains" },
         [13] = { str = "Kill #NPCCondors# for #DOID92# around #COORD[57,76]#", x = 57, y = 73, zone = "Redridge Mountains" },
         ...
         [15] = { str = "Go in the Inn and turn in #INID131#. You should now be level 20, accept #GETID150# in front of the shed, if you still have the #ITEM[Murloc Fins]# in your bag, turn it in." },
         [16] = { str = "Kill #NPCGnolls# North of Lakeshire for #DOID89#, then turn it in." },
