...
Table_003_Alliance_12to20 = {
   [1214] = {
      ...
      items = {
         ...
         [7] = { str = "Go do #DOID3524# pt.1 at #COORD[36,50]# grind from town to there to get #ITEM[Crawler Legs]# for #DOBuzzbox 827#.", x = 36, y = 50, zone = "Darkshore" },
         [8] = { str = "Turn in #INBuzzbox 827# at #COORD[36,46]# accept #GETID1001#, and turn in #INID3524# pt.1 accept #GETID4681# pt.2.", x = 36, y = 46, zone = "Darkshore" },
         [9] = { str = "Swim out and do #DOID4681# pt.2 at #COORD[32,46]#. Turn it in", x = 32, y = 46, zone = "Darkshore" },
         [10] = { str = "Do #DOID1001# by killing #NPCDarkshore Threshers# in the water. Turn it in at #COORD[42,29]# and accept #GETID1002#. You might have to grind a few mobs to hit lvl 13 to accept the quest.", x = 42, y = 29, zone = "Darkshore" },
         [11] = { str = "Stop at #COORD[42,32]# accept #GETID4723#.", x = 42, y = 32, zone = "Darkshore" },
         [12] = { str = "Turn in #INID954# pt.1 at #COORD[44,36]# grinding along the way, accept #GETID955# pt.2 killing #NPCGrells# around him for #ITEM[Grell Earring]#.", x = 44, y = 36, zone = "Darkshore" },
         [13] = { str = "Turn in #INID955# pt.2 at #COORD[44,36]# accept #GETID956# pt.3", x = 44, y = 36, zone = "Darkshore" },
         [14] = { str = "Do #DOID956# pt.3 by killing #NPCDeth'ryll Satyr# and turn it in accept #GETID957# pt.4 " },
         ...
         [17] = { str = "Run down to #NPCAmeth’Aran# at #COORD[40,59]# and accept #GETID953#.", x = 40, y = 59, zone = "Darkshore" },
         [18] = { str = "Do #DOThe Fall of Ameth'Aran#, #DOID957# pt.4, #DOTools of the Highborne# and #DOFor Love Eternal# in this area." },
         ...
         [21] = { str = "Hearth back to Auberdine, turn in #INFor Love Eternal#, #INID4723#, #INThe Red Crystal#, accept #GETID4812#" },
         [22] = { str = "Fill the #ITEM[Empty Water Tube]# in the Moonwell for #DOAs Water Cascades#, turn in #INPlagued Lands#, accept #GETID2138#, turn in #INID984# pt.1 accept #GETID985# Pt.2 and #GETID4761#. Accept #GETID965# pt.1 upstairs." },
         [23] = { str = "Go in the merchant house, turn in #INTools of the Highborne# and #INThundris Windweaver#, accept #GETID4762#." },
         [24] = { str = "You should be 14 by now, get skills in Darnassus and be sure to accept the quest #GETID730# from #NPCChief Archaeologist Greywhisker# at #COORD[23,64]#" },
      }
   },
   [1417] = {
      ...
      items = {
         ...
         [3] = { str = "Kill #NPCMoonstalkers# and #NPCRabid Thistle Bears# all around #COORD[48,30]#, for #DOID2138# and #DOID1002#, then head to #COORD[50,25]# for #DOThe Cliffspring River#.", x = 50, y = 25, zone = "Darkshore" },
         ...
         [7] = { str = "Head south to #COORD[47,48]# to turn in #INAs Water Cascades#, accept #GETID4813#.", x = 47, y = 48, zone = "Darkshore" },
         ...
         [14] = { str = "Accept #GETID1138#, turn in #INCave Mushrooms# and accept #GETID948#, turn in #INThe Fragments Within#, turn in #INTrouble In Darkshore# and accept #GETID729#" },
         [15] = { str = "Turn in #INThe Cliffspring River#, accept #GETID4763#, turn in #INID2138# and accept #GETID2139#, turn in #INID985# pt.2 accept #GETID986#" },
   ...
   [1718] = {
      ...
      items = {
         ...
         [10] = { str = "Turn in #INA Hunter's Boast# accept #GETID258#. Kill #NPCElder Mountain Boar# at around #COORD[76,46]#.", x = 76, y = 46, zone = "Loch Modan" },
         [11] = { str = "Turn in #INA Hunter's Challenge#, accept #GETID271# pt.1." },
         [12] = { str = "Go to #COORD[64,48]# and accept #GETID2038#. Do #DOCrocolisk Hunting# here on the shore, and on the island at #COORD[54,38]# if necessary.", x = 64, y = 48, zone = "Loch Modan" },
         ...
         [14] = { str = "Access the dam from the west side and accept #GETID161# pt.1 at #COORD[46,14]#, then run out the east entrance and turn it in at the #ITEMSuspicious Barrel#, accept #GETID199# pt.2", x = 45, y = 13, zone = "Loch Modan" },
         [15] = { str = "Run back and turn in #INID199# pt.2 at #COORD[46,14]#, SKIP #SKIPID250# pt.3.", x = 45, y = 13, zone = "Loch Modan" },
         [16] = { str = "Run down to Thelsamar and turn in #INExcavation Progress Report# at #COORD[37,47]#, accept #GETID301#.", x = 37, y = 47, zone = "Loch Modan" },
         [17] = { str = "Go to #COORD[38,61]# and do #DOID271# pt.1.", x = 38, y = 61, zone = "Loch Modan" },
         [18] = { str = "Run back to the house at #COORD[83,62]# turn in #INCrocolisk Hunting# and #INID271# pt.1#, accept #GETID531# pt.2, and turn it in.", x = 83, y = 62, zone = "Loch Modan" },
   ...
   [1820] = {
      ...
      items = {
         ...
         [2] = { str = "Accept #GETID244# from #NPCGuard Parker# at #COORD[15,71]#.", x = 15, y = 71, zone = "Redridge Mountains" },
         [3] = { str = "Turn in #INEncroaching Gnolls# at #COORD[30,60]#, accept #GETID246#. Get the flightpath.", x = 30, y = 60, zone = "Redridge Mountains" },
         ...
         [10] = { str = "Turn in #INA Free Lunch# at #COORD[15,71]#, accept #GETID130#.", x = 15, y = 71, zone = "Redridge Mountains" },
         ...
         [14] = { str = "Run back to Lakeshire, turn in #INAssessing the Threat# near the flightpath. Go to the two houses West of Lakeshire, at #COORD[23,46]# and turn in #INRedridge Goulash# and #INVisit the Herbalist#, accept #GETID131#", x = 23, y = 46, zone = "Redridge Mountains" },
         [15] = { str = "Go in the Inn and turn in #INDelivering Daffodils#. You should now be level 20, accept #GETID150# in front of the shed, if you still have the #ITEM[Murloc Fins]# in your bag, turn it in." },
