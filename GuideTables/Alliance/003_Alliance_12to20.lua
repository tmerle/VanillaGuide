...
Table_003_Alliance_12to20 = {
	[1214] = {
		...
		items = {
			...
			[11] = { str = "Go do #DOWashed Ashore pt.1# at #COORD[36,50]# grind from town to there to get #ITEMCrawler Legs# for #DOBuzzbox 827#.", x = 36, y = 50, zone = "Darkshore" },
			...
			[15] = { str = "#DOBuzzbox 411# #NPCDarkshore Threshers# are out in the water, Turn it in at #COORD[41,28]# accept #GETBuzzbox 323#", x = 41, y = 28, zone = "Darkshore" },
			[16] = { str = "Stop at #COORD[36,51]# accept #GETBeached Sea Creature#.", x = 36, y = 51, zone = "Darkshore" },
			[17] = { str = "#DOBashal'Aran pt.1# at #COORD[44,36]# grinding along the way, accept #GETBashal'Aran pt.2# killing #NPCGrells# around him for #ITEM[Grell Earring]#.", x = 44, y = 36, zone = "Darkshore" },
			[18] = { str = "Turn in #INBashal'Aran pt.2# at #COORD[44,36]# accept #GETBashal’Aran pt.3#", x = 44, y = 36, zone = "Darkshore" },
			[19] = { str = "Do #DOBashal’Aran pt.3# by killing #NPCDeth'ryll Satyr# and turn it in accept #GETBashal’Aran pt.4# " },
			...
			[32] = { str = "Don’t do #SKIPDeep Ocean, Vast Sea#, it’s too hard and not worth it" },
			...
			[39] = { str = "You should be 14 by now, get skills in Darnassus and be sure to accept the quest #GETTrouble In Darkshore# from #NPCChief Archaeologist Greywhisker# at #COORD[23,64]#" },
		}
	},
	[1417] = {
		...
		items = {
			...
			[3] = { str = "Kill #NPCMoonstalkers# and #NPCRabid Thistle Bears# all around #COORD[48,30]# while you head to #COORD[50,25]# for #DOThe Cliffspring River#.", x = 50, y = 25, zone = "Darkshore" },
			...
			[12] = { str = "Kill #NPCGrizzled Thistle Bear# south of Grove of the Ancients for #DOBuzzbox 525# then turn it in at #COORD[41,80]#.", x = 41, y = 80, zone = "Darkshore" },
			...
			[14] = { str = "Grind over to #COORD[32,80]# and get #GETBeached Sea Creature# #VIDEO[Nostalrius] - This quest creature is located at 41,32# .", x = 32, y = 80, zone = "Darkshore" },
			...
			[24] = { str = "Fill the #ITEMCleansing Bowl# at the Moonwell" },
			[25] = { str = "You should be level 16 now, fly to Darnassus and get new skills." }, --WUT? that went fast!
			...
			[29] = { str = "Clear around the bonfire at #COORD[52,33]# and place the food. Don’t worry they turn friendly.When #NPCXabraxxis# appears kill him. #ITEMTalisman# falls beside.", x = 52, y = 33, zone = "Darkshore" },
			...
			[33] = { str = "Do #DOFruit of the Sea# from #NPCCrawlers# around here." },
