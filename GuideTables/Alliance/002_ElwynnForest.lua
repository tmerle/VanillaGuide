...
-----------1-10 Elwynn Forest
	...
	[0110] = {
		...
		items = {
			...
			[24] = { str = "Enter the Inn at #COORD[42,65]#", x = 42, y = 65, zone = "Elwynn Forest" },
			[25] = { str = "Accept #GETKobold Candles#" },
			[26] = { str = "Near the bar turn in #INRest and Relaxation# and make Goldshire your home" },
			...
			[35] = { str = "Go west some to the river at #COORD[30,86]# and turn in #INYoung Lovers# accept #GETSpeak with Gramma#", x = 30, y = 86, zone = "Elwynn Forest" },
			[36] = { str = "Go back to #COORD[34,84]# and turn in #INSpeak with Gramma# in the house, accept #GETNote to William#", x = 34, y = 84, zone = "Elwynn Forest" },
			[37] = { str = "Run back east to #COORD[43,86]# and turn in #INBack to Billy# accept #GETGoldtooth#", x = 43, y = 86, zone = "Elwynn Forest" },
			[38] = { str = "Go in the bottom entrance of the Fargodeep Mine at #COORD[39,82]# and to about #COORD[41,78]# inside and kill #NPCGoldtooth# for #DOGoldtooth# You should ding level 7 during this quest.", x = 41, y = 78, zone = "Elwynn Forest" },
			[39] = { str = "Hearth back to Goldshire" },
			[40] = { str = "In the Inn turn in #INKobold Candles# accept #GETShipment to Stormwind# also turn in #INNote to William# accept #GETCollecting Kelp#" },
