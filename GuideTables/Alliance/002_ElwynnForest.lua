...
Table_002_ElwynnForest = {
   [0110] = {
      ...
      items = {
         ...
         [7] = { str = "Run into the house at #COORD[48,41]# and turn in #INKobold Camp Cleanup#, accept #GETID3100# and #GETID15#.", x = 48, y = 41, zone = "Elwynn Forest" },
         ...
         [12] = { str = "Run back to the abbey at #COORD[48,42]# and turn in #INBrotherhood of Thieves#, accept #GETID3903# and #GETID6#.", x = 48, y = 42, zone = "Elwynn Forest" },
         [13] = { str = "Go inside the house and turn in #INInvestigate Echo Ridge#, accept #GETID21#, then get new skills." },
         [14] = { str = "Go North of the house at #COORD[50,39]# next to the barn, turn in #INMilly Osworth#, accept #GETID3904#.", x = 50, y = 39, zone = "Elwynn Forest" },
         [15] = { str = "Go back East and grab the #ITEMgrapes# in the garden at #COORD[54,48]# for #DOID3904# then NorthEast to #COORD[57,48]# you’ll see a shack with #NPCGarrick Padfoot#. Kill him for #DOBounty on Garrick Padfoot#.", x = 57, y = 48, zone = "Elwynn Forest" },
         ...
         [20] = { str = "Go inside the house, turn in #INSkirmish at Echo Ridge#, accept #GETID54#." },
         ...
         [24] = { str = "Enter the Inn at #COORD[42,65]#, accept #GETID60#, turn in #INRest and Relaxation# and make Goldshire your home.", x = 42, y = 65, zone = "Elwynn Forest" },
         [25] = { str = "Exit the Inn, turn in #INReport to Goldshire#, accept #GETID62#." },
         ...
         [31] = { str = "Go to #COORD[43,86]# and turn in #INLost Necklace#, accept #GETID86# then kill boars until it’s finished.", x = 43, y = 86, zone = "Elwynn Forest" },
         [32] = { str = "Go back West to #COORD[34,84]# and turn in #INID86#, and accept #GETID84#.", x = 34, y = 84, zone = "Elwynn Forest" },
         [33] = { str = "Go West to the river at #COORD[30,86]#, and turn in #INYoung Lovers#, accept #GETID111#.", x = 30, y = 86, zone = "Elwynn Forest" },
         [34] = { str = "Go back to #COORD[34,84]# and turn in #INID111#, accept #GETID107#.", x = 34, y = 84, zone = "Elwynn Forest" },
         [35] = { str = "Run back east to #COORD[43,86]# and turn in #INBack to Billy# accept #GETID87#.", x = 43, y = 86, zone = "Elwynn Forest" },
         ...
         [38] = { str = "In the Inn turn in #INKobold Candles#, accept #GETID61# also turn in #INNote to William#, accept #GETID112#." },
         [39] = { str = "Straight outside the Inn, turn in #INThe Fargodeep Mine# accept #GETID76#." },
         [40] = { str = "South near the fence, turn in #INGold Dust Exchange# You should have dinged level 7 now, accept #GETID40#, accept #GETID35# by the blacksmith." },
         ...
         [43] = { str = "Run to the bridge at #COORD[74,72]# and turn in #INFurther Concerns#, accept #GETID37# and #GETID52#.", x = 74, y = 72, zone = "Elwynn Forest" },
         ...
         [46] = { str = "Run just West of the waterfall at #COORD[73,60]# touch the #ITEMMangled Body#, and turn in #INFind the Lost Guards#, accept #GETID45# You should now be level 8, if not grind until you are.", x = 73, y = 60, zone = "Elwynn Forest" },
         [47] = { str = "Go to the Murloc camp at #COORD[80,56]# and loot the #ITEMMangled Body# there, and turn in #INID45#, accept #GETID71#.", x = 80, y = 56, zone = "Elwynn Forest" },
         ...
         [50] = { str = "Go back to #COORD[74,72]# near the bridge and turn in #INProtect the Frontier# and #INReport to Thomas#, accept #GETID39#.", x = 74, y = 72, zone = "Elwynn Forest" },
         ...
         [56] = { str = "Turn in #INCollecting Kelp# accept #GETID114#, #INThe Jasperlode Mine# and #INDeliver Thomas' Report# SKIP #SKIPCloth and Leather Armor# accept #GETID239#. Accept #GETID1097# at the blacksmith." },
         ...
         [59] = { str = "Go NorthWest to #COORD[24,74]# and turn in #INWestbrook Garrison Needs Help!#, accept #GETID11# and #GETID176# from the #ITEMWanted! sign#.", x = 24, y = 74, zone = "Elwynn Forest" },
   ...
   [1012] = {
      ...
      items = {
         ...
         [7] = { str = "Get the flightpath at #COORD[56,53]# and turn in #INA Swift Message# accept #GETID6281#.", x = 56, y = 53, zone = "Westfall" },
         ...
         [11] = { str = "Go to #COORD[74,48]# and turn in #INContinue to Stormwind# accept #GETID6261#.", x = 74, y = 48, zone = "Stormwind City" },
         [12] = { str = "Go to #COORD[52,12]# and turn in #INElmore's Task# accept #GETID353# this will be done on the way to the Wetlands.", x = 52, y = 12, zone = "Stormwind City" },
         [13] = { str = "Go to #COORD[66,62]# and turn in #INStormpike's Delivery# accept #GETID2#Return to Lewis# then fly back to Westfall.", x = 66, y = 62, zone = "Stormwind City" },
