...
Table_002_ElwynnForest = {
   [0110] = {
      ...
      items = {
         ...
         [5] = { str = "Kill #NPCWolves# in front of you for #DOID33#, while working your way to the #NPCKobold Vermin# at #COORD[47,35]# for #DOID7#.", x = 47, y = 35, zone = "Elwynn Forest" },
         ...
         [10] = { str = "Go NorthWest toward the cave at #COORD[47,32]#, and kill #NPCKobold Workers# on the way for #DOID15#.", x = 47, y = 32, zone = "Elwynn Forest" },
         [11] = { str = "Go West to #COORD[54,40]# and go south killing #NPCDefias# for #DOID18#, you should be level 4 by the time you're done, if not grind until you are.", x = 54, y = 40, zone = "Elwynn Forest" },
         ...
         [15] = { str = "Go back East and grab the #ITEMgrapes# in the garden at #COORD[54,48]# for #DOID3904# then NorthEast to #COORD[57,48]# you'll see a shack with #NPCGarrick Padfoot#. Kill him for #DOID6#.", x = 57, y = 48, zone = "Elwynn Forest" },
         [16] = { str = "Go back to #COORD[50,39]# and turn in #INID3904#, accept #GETID3905#.", x = 50, y = 39, zone = "Elwynn Forest" },
         [17] = { str = "Go into the cave at #COORD[47,31]# and kill #NPCKobold Laborer# for #DOID21#.", x = 47, y = 31, zone = "Elwynn Forest" },
         ...
         [28] = { str = "Go South to the Fargodeep Mine at #COORD[39,82]# and kill the #NPCKobold# until you complete all 3 quests #DOID62#, #DOID47#, and #DOID60#. Use the lower enterance, as it is easier.", x = 39, y = 82, zone = "Elwynn Forest" },
         ...
         [31] = { str = "Go to #COORD[43,86]# and turn in #INID85#, accept #GETID86# then kill boars until it's finished.", x = 43, y = 86, zone = "Elwynn Forest" },
         ...
         [36] = { str = "Go in the bottom entrance of the Fargodeep Mine at #COORD[39,82]# and to about #COORD[41,78]#, kill #NPCGoldtooth# for #DOID87#. You should ding level 7 during this quest.", x = 41, y = 78, zone = "Elwynn Forest" },
         ...
         [41] = { str = "Kill #NPCMurlocs# around the lake at #COORD[51,65]# for #DOID112#.", x = 51, y = 65, zone = "Elwynn Forest" },
         ...
         [46] = { str = "Run just West of the waterfall at #COORD[73,60]# touch the #ITEMMangled Body#, and turn in #INID37#, accept #GETID45# You should now be level 8, if not grind until you are.", x = 73, y = 60, zone = "Elwynn Forest" },
         ...
         [49] = { str = "Cross the road and go south and east and finish killing the #NPCBears# and #NPCWolves# for #DOID52#." },
         [50] = { str = "Go back to #COORD[74,72]# near the bridge and turn in #INID52# and #INID71#, accept #GETID39#.", x = 74, y = 72, zone = "Elwynn Forest" },
         [51] = { str = "Go down to the pumpkin patch at #COORD[69,78]# and kill #NPCDefias# for #DOID83#.", x = 69, y = 78, zone = "Elwynn Forest" },
         ...
         [60] = { str = "Go just South of the road and start killing #NPCGnolls# for #DOID11# they can also drop a #ITEMGold Schedule# which starts a quest." },
   ...
   [1012] = {
      ...
      items = {
         ...
         [2] = { str = "Go to #COORD[60,19]# and turn in #INID184# if you found #ITEM[Westfall Deed]#.", x = 60, y = 19, zone = "Westfall" },
         ...
         [26] = { str = "Kill #NPCTroggs# from #COORD[27,53]# and north for #DOID217# and #DOID267#.", x = 27, y = 53, zone = "Loch Modan" },
