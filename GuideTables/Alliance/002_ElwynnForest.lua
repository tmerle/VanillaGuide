...
-----------1-10 Elwynn Forest
	...
	[0110] = {
		...
		items = {
			...
			[35] = { str = "Go west some to the river at [30,86] and turn in #TURNINYoung Lovers# accept #ACCEPTSpeak with Gramma#", x = 30, y = 86, zone = "Elwynn Forest" },
			...
			[37] = { str = "Run back east to [43,86] and turn in #TURNINBack to Billy# accept #ACCEPTGoldtooth#", x = 43, y = 86, zone = "Elwynn Forest" },
			...
			[46] = { str = "Run to the bridge at [74,72] and turn in #TURNINFurther Concerns# accept #ACCEPTFind the Lost Guards# and #ACCEPTProtect the Frontier#", x = 74, y = 72, zone = "Elwynn Forest" },
			[47] = { str = "Stop at the house NE of here at [79,69] and accept #ACCEPTRed Linen Goods#", x = 79, y = 69, zone = "Elwynn Forest" },
			[48] = { str = "At the center of the camp, [81,66], accept #ACCEPTA Bundle of Trouble#", x = 81, y = 66, zone = "Elwynn Forest" },
			[49] = { str = "Run just west of the waterfall at [73,60] touch the mangled body and turn in #TURNINFind the Lost Guards# accept #ACCEPTDiscover Rolf’s Fate# You should now be level 8, if not grind until you are.", x = 73, y = 60, zone = "Elwynn Forest" },
			[50] = { str = "Go to the murloc camp at [80,56] and loot the mangled body there (might need a group, but usually always people here) and turn in #TURNINDiscover Rolf’s Fate# accept #ACCEPTReport to Thomas#", x = 80, y = 56, zone = "Elwynn Forest" },
			...
			[54] = { str = "Go back to [74,72] near the bridge and turn in #TURNIN“Protect the Frontier”# and #TURNIN“Report to Thomas”# accept #ACCEPT“Deliver Thomas' Report”#", x = 74, y = 72, zone = "Elwynn Forest" },
			...
			[57] = { str = "Go to [79,69] and turn in #TURNINRed Linen Goods# it should make you level 9 or bring you really close", x = 79, y = 69, zone = "Elwynn Forest" },
			[58] = { str = "Stop at the bridge again at [74,72] and accept #ACCEPT“Report to Gryan Stoutmantle”# must be level 9 to accept", x = 74, y = 72, zone = "Elwynn Forest" },
			...
			[65] = { str = "Go NW to [24,74] and turn in #TURNIN“Westbrook Garrison Needs Help!”# accept #ACCEPT“Riverpaw Gnoll Bounty”# and accept #ACCEPT“Hogger!”# from the wanted sign", x = 24, y = 74, zone = "Elwynn Forest" },
			...
			[67] = { str = "Go back up to [24,74] and turn in #TURNIN“Riverpaw Gnoll Bounty”#", x = 24, y = 74, zone = "Elwynn Forest" },
...
-----------10-12 Westfall and Loch Modan
	...
	[1012] = {
		...
		items = {
			...
			[2] = { str = "Go to [60,19] and turn in #TURNIN“Furlbrow’s Deed”# if you found it before", x = 60, y = 19, zone = "Westfall" },
			...
			[7] = { str = "Get the FP at [56,53] and turn in #TURNIN“A Swift Message”# accept #ACCEPT“Continue to Stormwind”#", x = 56, y = 53, zone = "Westfall" },
			[8] = { str = "Fly to SW unless you did hogger, then hearth to Goldshire and turn it in outside the Inn then buy new skills" },
			[9] = { str = "In SW go to [56,66] and turn in #TURNIN“Shipment to Stormwind”#", x = 56, y = 66, zone = "Stormwind City" },
			[10] = { str = "Train new weapons at [57,57]", x = 57, y = 57, zone = "Stormwind City" },
			[11] = { str = "Go to [74,48] and turn in #TURNIN“Continue to Stormwind”# accept #ACCEPT“Dungar Longdrink”#", x = 74, y = 48, zone = "Stormwind City" },
			[12] = { str = "Go to [52,12] and turn in #TURNIN“Elmore's Task”#  accept #ACCEPT“Stormpike's Delivery”# this will be done on the way to the Wetlands", x = 52, y = 12, zone = "Stormwind City" },
			[13] = { str = "Go to [78,45] and accept #ACCEPT“A Warrior’s Training”# or your classes level 10 quest.", x = 78, y = 45, zone = "Stormwind City" },
			[14] = { str = "Go to [66,62] and turn in #TURNIN“Stormpike's Delivery”# accept #ACCEPT#“Return to Lewis”# then fly back to Westfall", x = 66, y = 62, zone = "Stormwind City" },
			[15] = { str = "Go to the tower at [56,47] and turn in #TURNIN“Return to Lewis”#", x = 56, y = 47, zone = "Westfall" },
			[16] = { str = "Fly back to SW #NPCWarrior:# Go in the bar at [74,37] and turn in #TURNIN“A Warrior’s Training”# accept #ACCEPT“Bartleby the Drunk”# then turn around and hand it in accept #ACCEPT“Beat Bartleby#", x = 74, y = 37, zone = "Stormwind City" },
			...
			[18] = { str = "Go into the tram at [64,08] and take it to IF", x = 64, y = 8, zone = "Stormwind City" },
			...
			[23] = { str = "Run east to [69,56] and accept #ACCEPT“The Public Servant”#", x = 69, y = 56, zone = "Dun Morogh" },
			[24] = { str = "Go behind him and accept #ACCEPT“Those Blasted Troggs!”#" },
			[25] = { str = "Go in the pit below and kill the troggs here and in the cave for both quests then turn them back in at [69,56]", x = 69, y = 56, zone = "Dun Morogh" },
			[26] = { str = "Go east to [81,53] and follow the path into Loch Modan", x = 81, y = 53, zone = "Dun Morogh" },
			[27] = { str = "Go to [22,73] and accept #ACCEPT“In Defense of the King's Lands”#", x = 22, y = 73, zone = "Loch Modan" },
			[28] = { str = "Go inside the bunker and accept #ACCEPT“The Trogg Threat”#" },
			[29] = { str = "Go grab the FP at [34,51]", x = 34, y = 51, zone = "Loch Modan" },
